                  ...
                  return (
                    <div
                      ...
                      className={`p-6 sm:p-7 rounded-xl bg-white border border-slate-200 shadow-sm hover:border-slate-300 hover:shadow-md transition-all flex flex-col justify-between ${
                        isLastOdd ? "md:col-span-2 bg-gradient-to-br from-white via-white to-blue-50/20" : ""
                      }`}
                    >
                      <div className={isLastOdd ? "grid grid-cols-1 lg:grid-cols-12 gap-6 items-start" : ""}>
                        <div className={isLastOdd ? "lg:col-span-8" : ""}>
                        ...
                        {/* If isLastOdd, layout deliverables on side */}
                        {isLastOdd ? (
                          <div className="lg:col-span-4 bg-slate-50/80 border border-slate-200/80 p-5 rounded-lg space-y-3">
                            ...
                            <div className="space-y-2">
                              {(lang === "no" ? c.metricsNo : c.metricsEn).map((m, i) => (
                                ...
                                >
                                  <CheckCircle2 className="w-3.5 h-3.5 text-[#009FE3] shrink-0 mt-0.5" />
                                  <span>{m}</span>
                                </div>
                              ))}
                            </div>
                      ...
                      {/* Regular Metrics Footer for non-isLastOdd */}
                      {!isLastOdd && (
