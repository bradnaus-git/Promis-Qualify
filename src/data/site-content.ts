...
export const SITE_CONTENT = {
  ...
  caseStudies: [
    ...
    {
      id: "case-ruter-reise",
      titleNo: "RuterReise: Nasjonal reiseplanlegger & kompetanseheving",
      titleEn: "RuterReise: Travel Planner & QA Enablement",
      clientNo: "Ruter As",
      clientEn: "Ruter AS",
      logo: "/images/references/ruterreise.png",
      sector: "transport",
      domainNo: "Reiseinformasjon & Ruteplanlegging",
      domainEn: "Travel Information & Journey Planning",
      summaryNo: "Ledelse av hele testløpet for RuterReise og Ruter.no (inkl. Brakar, Opplandstrafikk og ØKT), samt opplæring og mentorering av interne testressurser.",
      summaryEn: "Leading test lifecycle for RuterReise and Ruter.no (serving regional partners), including training and mentoring internal client test teams.",
      fullDescriptionNo: "RuterReise og Ruter.no er Ruters kjente løsning for reiseplanlegging og avgangstider i sanntid for millioner av reisende, og benyttes også av samarbeidende kollektivselskaper som Brakar, Opplandstrafikk og ØKT. Promis Qualify ledet testen på kundesiden for hele testløpet for samtlige reiseinformasjonstjenester, og fikk medio 2017 mandat til å lære opp interne testressurser.",
      fullDescriptionEn: "RuterReise and Ruter.no deliver journey planning and real-time schedules for millions of passengers. Promis Qualify directed customer QA across all traveler information services and spearheaded the mentoring of internal staff.",
      metricsNo: ["Millioner av månedlige reisesøk", "Bred flerfylkes koordinering", "Opplæring & kompetanseheving av internt team"],
      metricsEn: ["Millions of monthly route queries", "Multi-county coordination", "Internal client team training & enablement"],
      tags: ["Transport", "Reiseplanlegger", "Mentorering"],
    },
    {
      id: "case-sykehus",
      titleNo: "Nytt storsykehus: Testledelse av integrerte IKT- og byggesystemer",
      titleEn: "Regional Hospital: Integrated IT & BMS Commissioning",
