...
export const SITE_CONTENT = {
  brand: {
    ...
    orgNumber: "913 862 822",
  },
  metrics: [
    { labelNo: "ISTQB-sertifisering", labelEn: "ISTQB Certified", value: "100%", subNo: "De fleste på Advanced-nivå", subEn: "Majority at Advanced level" },
    { labelNo: "Erfaring i snitt", labelEn: "Avg. Experience", value: "15+ år", subNo: "Senior rådgivere og ledere", subEn: "Senior advisors and leads" },
    { labelNo: "Samfunnskritiske prosjekter", labelEn: "Critical Deliveries", value: "120+", subNo: "Offentlig & privat sektor", subEn: "Public & private sector" },
  ...
  services: [
    {
      ...
      bulletsNo: [
        "Strategisk testplanlegging og risikostyring",
        "Etablering og ledelse av tverrfaglige testteam",
        "Kvalitetsrapportering til prosjekt- og toppledelse",
    ...
    },
    {
      ...
      bulletsNo: [
        "Modenhetsanalyse (TMMi / ISO 29119)",
        "Strategi for testautomatisering og CI/CD",
        "Uavhengig verktøyevaluering og anskaffelsesbistand",
    ...
    },
    {
      ...
      bulletsNo: [
        ...
        "Tidlig tverrfaglig integrasjonstest før innbygging",
        "Gjennomprøving av samspill mellom elektro, VVS, IKT og sikkerhet",
        "Erfaring fra sykehus, flyplasser og samferdselsterminaler"
      ],
      bulletsEn: [
    ...
    values: [
      {
        titleNo: "Balanse",
        titleEn: "Balance",
        descNo: "Hos oss er livet mer enn bare jobb. Vi legger til rette for overskudd, familieliv og faglig ro.",
        descEn: "Work is just one part of a fulfilling life. We prioritize family balance, autonomy, and sustainable pacing.",
      },
      {
        titleNo: "Inkludering",
        titleEn: "Inclusion",
        descNo: "Et raus og åpent fellesskap hvor alles perspektiver verdsettes og tas på alvor.",
        descEn: "A generous, welcoming community where diverse perspectives are genuinely respected and celebrated.",
      },
      {
        titleNo: "Engasjement",
        titleEn: "Dedication",
        descNo: "Ekte lidenskap for faget. Vi deler kunnskap gjennom ProLog, konferanser og mentorordninger.",
        descEn: "True passion for QA craft. We share knowledge actively via ProLog blog, international conferences, and mentorship.",
      },
    ],
    communityNo: "Vi er stolte av vårt mer enn 10 år lange partnerskap med 'Education for Life Nepal', hvor vi bidrar til utdanning for underprivilegerte barn i Katmandudalen.",
    communityEn: "We are proud of our 10+ year commitment to 'Education for Life Nepal', actively supporting education for underprivileged children in the Kathmandu Valley.",
  },
  salaryModel: {
    titleNo: "Radikal åpenhet: Velg din egen lønnsmodell",
    titleEn: "Radical Transparency: Choose Your Compensation Model",
    descNo: "Promis Qualify har en av konsulentbransjens mest rettferdige og transparente lønnsmodeller. Du kan velge modell for ett kalenderår av gangen etter dine personlige behov.",
    descEn: "Promis Qualify offers one of the industry's most transparent and equitable compensation structures. Select your model annually based on your personal financial preferences.",
    grunnbelopG: 124028, // Folketrygdens grunnbeløp G (approx current NOK)
    models: [
      {
        id: "standard",
        nameNo: "Standard (Maksimal oppside)",
        nameEn: "Standard (Maximum Upside)",
        baseGuaranteeG: 6,
        sharePercentage: 55,
        descNo: "6 G garantilønn i bunn (kr 744 168,-) med bransjens høyeste provisjonsandel. Perfekt for deg med stabil oppdragsdekning som vil høste fruktene av egen innsats.",
        descEn: "6 G guaranteed base (~NOK 744,168) with industry-leading commission share. Ideal for experienced consultants seeking maximum upside.",
      },
      {
        id: "secure",
        nameNo: "Trygghet (Høyere garantilønn)",
        nameEn: "Security (Higher Guaranteed Base)",
        baseGuaranteeG: 7,
        sharePercentage: 48,
        descNo: "7 G garantilønn i bunn (kr 868 196,-) med moderat provisjonsandel. Gir ekstra forutsigbarhet i hverdagen og lavere svingninger.",
        descEn: "7 G guaranteed base (~NOK 868,196) with balanced profit-sharing. Provides higher baseline predictability with steady upside.",
      },
      {
        id: "fixed",
        nameNo: "Fastlønn (100% Forutsigbarhet)",
        nameEn: "Fixed Base (100% Predictability)",
        baseGuaranteeG: 8.5,
        sharePercentage: 0,
        descNo: "Konkurransedyktig fastlønn uavhengig av faktureringsgrad for deg som prioriterer full trygghet og jevn månedlig utbetaling.",
        descEn: "Competitive fixed compensation regardless of billing fluctuations, tailored for professionals prioritizing total stability.",
      },
    ],
  },
  promisFamily: {
